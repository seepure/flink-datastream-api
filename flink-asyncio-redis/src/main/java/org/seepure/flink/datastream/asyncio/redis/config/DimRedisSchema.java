...
@Deprecated
public abstract class DimRedisSchema<IN> implements
        Serializable /*implements DeserializationSchema<Map<String, String>>*/ {
    ...
    public static DimRedisSchema getDimSchema(Map<String, String> configMap) throws IOException {
        ...
        switch (type) {
            ...
            case "redis.hash":
                ...
                break;
            case "string_split":
            case "redis.split_text":
                dimRedisSchema = new DimRedisSplitTextSchema();
                dimRedisSchema.parseConfig(schemaContent);
                break;
            default:
